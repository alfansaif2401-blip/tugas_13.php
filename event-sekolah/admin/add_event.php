...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO events (nama_event, tanggal, waktu, lokasi, deskripsi, penyelenggara, status, created_by) 
              VALUES ('$nama_event', '$tanggal', '$waktu', '$lokasi', '$deskripsi', '$penyelenggara', '$status', {$_SESSION['user_id']})";
...
<head>
    ...
    <title>Tambah Event - Event Sekolah</title>
    <style>
        * {
            margin: 0;
            padding: 0;
